...
function CartLineItem({layout, line}) {
  ...
  return (
    <li key={id} className="cart-line always-flex">
      {image && (
        <Image
          alt={title}
          aspectRatio="1/1"
      ...
      <div className="cartContents">
        ...
        <ul className="options always-flex">
...
export function CartSummary({cost, layout, children = null}) {
  ...
  return (
    <div aria-labelledby="cart-summary" className={className}>
      <div>
        <div className="always-flex justify aboveDiscount">
          <h4>Totals</h4>
...
function CartLineRemoveButton({lineIds}) {
  return (
    ...
    >
      <button type="submit">
        <small className="goAway">Remove</small>
        <svg
...
function CartLineQuantity({line}) {
  ...
  return (
    <div className="cart-line-quantiy">
      ...
      <div className="flex-vertical quantity text-center">
  ...
  return (
    <div>
      ...
      <UpdateDiscountForm discountCodes={codes}>
        <div className="always-flex discountForm">
